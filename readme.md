...
## 📝 Todo
- [x] Menambahkan remotehost untuk antarmuka pengguna grafis (GUI), ini termasuk xrdp, ssh, noVNC, dan lain-lain.
- [x] Menambahkan Dockerfile untuk membangun secara otomatis guna memastikan konsistensi dan keandalan.
- [x] Menambahkan ngrok akan memungkinkan server cloud Anda yang terekspos di balik NAT dan firewall untuk terhubung ke internet publik melalui terowongan aman.
...
## 👨🏾‍⚖️ License
This project is under terms of the [MIT License](LICENSE). bugs and error, create [issue](https://github.com/shopeebjm/github-vps/issues/new)
